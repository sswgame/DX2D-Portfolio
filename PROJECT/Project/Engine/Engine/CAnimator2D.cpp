...
void CAnimator2D::SetAnimation(const std::wstring& name, CAnimation2D* pAnimation)
{
	assert(nullptr == FindAnim(name));

	m_mapAnim.insert({name, pAnimation});
}
